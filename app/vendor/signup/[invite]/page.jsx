...
// Mock ported from ~/Desktop/blackbear/vendor-signup.html.
...
export default function Page() {
  ...
  <header className="topbar">
    ...
    <div className="tb-right">
      ...
      <a href="mailto:vendors@rentblackbear.com">vendors@rentblackbear.com</a>
    </div>
  </header>
  ...
  <div className="invite-banner">
    ...
    <div className="invite-text">
      <div className="invite-text-line"><strong>Harrison Cooper</strong> (Black Bear Rentals) invited you to join Black Bear Rentals as a vendor.</div>
  ...
  <div className="shell">
    ...
    <aside className="rail">
      ...
      <div className="rail-footer">
        ...
        <a href="mailto:vendors@rentblackbear.com">vendors@rentblackbear.com</a><br />
      ...
      <div className="content-body" id="contentBody">
        ...
        <section className="step-panel" data-panel="2">
          ...
          <div className="field">
            ...
            <div className="field-hint">When operators owe you money after you submit an invoice. Net 15 is the Black Bear Rentals default and what most vendors pick.</div>
          </div>
            ...
            <div className="radio-stack" id="achRow" data-required="1">
              ...
              <div className="radio-card" data-value="no">
                ...
                <div>
                  ...
                  <div className="radio-card-sub">You handle billing and collection yourself. Black Bear Rentals still tracks the job, but money stays between you and the operator.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="step-panel" data-panel="6">
          ...
          <div className="agreement-box">
            ...
            <ul className="agreement-list">
              ...
              <li><span>You're an <strong>independent contractor</strong>. Black Bear Rentals doesn't withhold taxes, provide benefits, or direct how you do the work. We just connect you and handle payment.</span></li>
