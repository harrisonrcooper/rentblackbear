...
// Mock ported from ~/Desktop/tenantory/compare.html.
  ...
  <section className="glance">
    <div className="glance-grid">
      ...
      <div className="vcard vcard-featured">
        ...
        <div className="vcard-logo vl-tenantory">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12 12 3l9 9" /><path d="M5 10v10h14V10" /><path d="M10 20v-6h4v6" /></svg>
        </div>
        <div className="vcard-name">Tenantory</div>
      ...
      <div className="vcard">
        ...
        <a className="vcard-link" href="vs-appfolio.html">Tenantory vs AppFolio <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg></a>
      </div>
      ...
      <div className="vcard">
        ...
        <a className="vcard-link" href="vs-buildium.html">Tenantory vs Buildium <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg></a>
      </div>
      ...
      <div className="vcard">
        ...
        <a className="vcard-link" href="vs-doorloop.html">Tenantory vs DoorLoop <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg></a>
      </div>
    ...
    <div className="compare">
      <table className="compare-table">
        <thead>
          <tr>
            <th>Feature</th>
            <th className="featured">Tenantory<span className="compare-col-sub">$99/mo flat</span></th>
    ...
    <div className="cost-card">
      <div className="cost-head">
        ...
        <div className="cost-legend">
          <div className="cost-legend-item"><span className="cost-legend-swatch cl-tn" />Tenantory</div>
      ...
      <div className="cost-rows">
        <div className="cost-row win">
          <div className="cost-row-name">Tenantory</div>
  ...
  <section className="switch">
    ...
    <div className="switch-grid">
      ...
      <a className="switch-card" href="vs-buildium.html">
        ...
        <div className="switch-meta">Biggest gotcha: <strong>Buildium's chart of accounts is more granular than Tenantory</strong>. We consolidate 80+ categories into 14 Schedule-E lines.</div>
  ...
  <section className="faq" id="faq">
    ...
    <div className="faq-list">
      ...
      <div className="faq-item">
        ...
        <div className="faq-a">Yes, it's biased in the sense that I think Tenantory is the best fit for most small PMs &mdash; that's why I built it after using the other three. It's <strong>not</strong> biased in the sense of misrepresenting the competition. Every number on this page is from the vendor's public pricing page or a real invoice I've personally paid. Where they beat Tenantory &mdash; AppFolio's deeper accounting, Buildium's double-entry GL, DoorLoop's native mobile apps &mdash; I say so.</div>
      </div>
      ...
      <div className="faq-item">
        ...
        <div className="faq-a">Then use AppFolio. Specifically: if you need AppFolio Plus features (AI leasing assistant for 500+ unit leasing teams, corporate AP approval chains, investor-grade fund accounting), Tenantory isn't there yet. If you need AppFolio Core features (rent roll, owner statements, maintenance, e-sign, CAM reconciliation), Tenantory does all of those at 1/3 the price. The real question is whether you'll ever <strong>actually use</strong> the $280/mo worth of features. Most 25-unit PMs don't.</div>
      </div>
      ...
      <div className="faq-item">
        <button className="faq-q">Does Tenantory work for 500+ unit portfolios? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg></button>
