...
// Mock ported from ~/Desktop/blackbear/demo.html.
...
export default function Page() {
  ...
  <section className="hero">
    ...
    <h1>See Black Bear Rentals in <em>2 minutes</em>.</h1>
    ...
    <div className="scenes">
      ...
      <article className="scene" id="scene-1" data-next="scene-2">
        <div className="scene-head">
          ...
          <p className="scene-desc">Open Black Bear Rentals. Every number you care about — this week, this month, right now.</p>
        </div>
        <div className="frame">
          <div className="frame-bar">
            <div className="frame-dots"><span className="frame-dot r" /><span className="frame-dot y" /><span className="frame-dot g" /></div>
            <div className="frame-url"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>app.rentblackbear.com/dashboard</div>
          </div>
      ...
      <article className="scene" id="scene-3" data-next="scene-4">
        ...
        <div className="frame">
          <div className="frame-bar">
            <div className="frame-dots"><span className="frame-dot r" /><span className="frame-dot y" /><span className="frame-dot g" /></div>
            <div className="frame-url"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>app.rentblackbear.com/applications</div>
          </div>
          <div className="frame-body">
      ...
      <article className="scene" id="scene-4" data-next="scene-5">
        ...
        <div className="frame">
          <div className="frame-bar">
            <div className="frame-dots"><span className="frame-dot r" /><span className="frame-dot y" /><span className="frame-dot g" /></div>
            <div className="frame-url"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>app.rentblackbear.com/maintenance/T-2641</div>
          </div>
          <div className="frame-body" style={{minHeight: "420px"}}>
            <div className="split">
              ...
              <div className="split-pane">
                <div className="split-pane-label"><span className="dot" style={{color: "var(--gold)"}} />Vendor view &middot; vendor.rentblackbear.com</div>
                <div className="mnt-ticket">
      ...
      <article className="scene" id="scene-6" data-next="scene-7">
        ...
        <div className="frame">
          <div className="frame-bar">
            <div className="frame-dots"><span className="frame-dot r" /><span className="frame-dot y" /><span className="frame-dot g" /></div>
            <div className="frame-url"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>app.rentblackbear.com/reports/investor-april-2026.pdf</div>
          </div>
      ...
      <article className="scene" id="scene-7" data-next="scene-8">
        ...
        <div className="frame">
          <div className="frame-bar">
            <div className="frame-dots"><span className="frame-dot r" /><span className="frame-dot y" /><span className="frame-dot g" /></div>
            <div className="frame-url"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>app.rentblackbear.com/reports/schedule-e</div>
          </div>
          <div className="frame-body" style={{minHeight: "420px"}}>
      ...
      <article className="scene" id="scene-8" data-next="final">
        <div className="scene-head">
          ...
          <p className="scene-desc">Black Bear Rentals is invisible to your renters. The portal, the domain, the emails — all yours.</p>
        </div>
        <div className="frame">
          <div className="frame-bar">
            <div className="frame-dots"><span className="frame-dot r" /><span className="frame-dot y" /><span className="frame-dot g" /></div>
            ...
            <div className="brand-compare">
              <div className="brand-card">
                <div className="brand-card-head">
                  <span className="lock"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg> portal.rentblackbear.com</span>
                  <span>Starter plan</span>
                </div>
                <div className="brand-card-body">
                  <div className="brand-logo-row">
                    <div className="brand-mark blackbear">
                    ...
                    <div className="brand-domain">portal.rentblackbear.com</div>
                  </div>
                  ...
                  <div style={{fontSize: "11px", color: "var(--text-faint)", marginTop: "auto"}}>Powered by Black Bear Rentals</div>
  ...
  <section className="final-cta" id="final">
    <div className="cta-card">
      ...
      <div className="cta-actions">
        ...
        <a className="btn btn-ghost btn-xl" href="mailto:hello@rentblackbear.com?subject=Book%20a%20call">Book a 20-min call</a>
      </div>
