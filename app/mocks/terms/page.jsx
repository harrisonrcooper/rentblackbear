...
// Mock ported verbatim from ~/Desktop/tenantory/terms.html.
...
const MOCK_HTML = `<!-- Topbar -->
  ...
  <section class="hero">
    <div class="hero-inner">
      ...
      <p class="hero-sub">These Terms govern your use of Tenantory. We wrote them to be as clear as a legal document reasonably can be, with a plain-English summary up top for the parts that matter most.</p>
      <div class="hero-meta">
    ...
    <div class="grid">
      ...
      <main class="body">
        ...
        <section class="sec" id="s2">
          <h2><span class="num">02</span> Description of Service</h2>
        ...
        <section class="sec" id="s3">
          <h2><span class="num">03</span> Account Registration & Security</h2>
        ...
        <section class="sec" id="s4">
          <h2><span class="num">04</span> Subscription Plans & Billing</h2>
        ...
        <section class="sec" id="s5">
          <h2><span class="num">05</span> Founders' Cohort Terms</h2>
        ...
        <section class="sec" id="s6">
          <h2><span class="num">06</span> The Time-Back Guarantee</h2>
        ...
        <section class="sec" id="s8">
          <h2><span class="num">08</span> User Content & Intellectual Property</h2>
        ...
        <section class="sec" id="s9">
          <h2><span class="num">09</span> Third-Party Services</h2>
        ...
        <section class="sec" id="s10">
          <h2><span class="num">10</span> Payment Processing</h2>
        ...
        <section class="sec" id="s11">
          <h2><span class="num">11</span> Data & Privacy</h2>
        ...
        <section class="sec" id="s12">
          <h2><span class="num">12</span> Termination and Data Export</h2>
        ...
        <section class="sec" id="s13">
          <h2><span class="num">13</span> Disclaimer of Warranties</h2>
        ...
        <section class="sec" id="s14">
          <h2><span class="num">14</span> Limitation of Liability</h2>
        ...
        <section class="sec" id="s15">
          <h2><span class="num">15</span> Indemnification</h2>
        ...
        <section class="sec" id="s16">
          <h2><span class="num">16</span> Governing Law</h2>
        ...
        <section class="sec" id="s17">
          <h2><span class="num">17</span> Dispute Resolution; Arbitration; Class-Action Waiver</h2>
        ...
        <section class="sec" id="s18">
          <h2><span class="num">18</span> Modifications to Terms</h2>
        ...
        <section class="sec" id="s19">
          <h2><span class="num">19</span> Contact Information</h2>
        ...
        <div class="contact">
          ...
          <div>
            ...
            <div class="contact-sub">Reach our legal team directly. We reply within two business days.</div>
          </div>
