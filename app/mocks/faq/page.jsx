...
// Mock ported verbatim from ~/Desktop/tenantory/faq.html.
...
const MOCK_HTML = `<!-- Topbar -->
  <header class="topbar">
    ...
    <nav class="tb-nav">
      ...
      <a class="tb-nav-item active" href="faq.html">FAQ</a>
  ...
  <section class="hero">
    ...
    <p class="hero-sub">The ones we actually hear. Search, or jump to a section.</p>
  </section>

  <!-- Search -->
  <div class="search-wrap">
    <div class="search-box">
      <svg class="search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
      <input class="search-input" id="searchInput" type="text" placeholder="Try &quot;ACH fee&quot;, &quot;roommate&quot;, &quot;cancel&quot;, &quot;1099&quot;..." autocomplete="off" spellcheck="false">
    </div>
  ...
  <div class="main-wrap">
    ...
    <aside class="jump-nav">
      <div class="jump-nav-title">Jump to</div>
      <div class="jump-nav-list" id="jumpNav">
        <a href="#pricing" data-section="pricing">Pricing &amp; plans <span class="count">7</span></a>
        <a href="#getting-started" data-section="getting-started">Getting started <span class="count">6</span></a>
        <a href="#payments" data-section="payments">Rent &amp; payments <span class="count">7</span></a>
        <a href="#tenants-apps" data-section="tenants-apps">Tenants &amp; applications <span class="count">6</span></a>
        <a href="#leases" data-section="leases">Leases &amp; documents <span class="count">6</span></a>
        <a href="#accounting" data-section="accounting">Accounting &amp; taxes <span class="count">6</span></a>
        <a href="#tenants-asking" data-section="tenants-asking">For tenants <span class="count">5</span></a>
        <a href="#security" data-section="security">Security &amp; trust <span class="count">5</span></a>
      </div>
    </aside>
    ...
    <main class="content">
      ...
      <div class="empty-state" id="emptyState">
        ...
        <p>Try a shorter phrase, or <a href="mailto:hello@tenantory.com" style="color:var(--blue);font-weight:600;">email us</a> and we'll answer directly (and add it here).</p>
      </div>

      <!-- 1. Pricing & plans -->
      <section class="faq-section" id="pricing" data-section="pricing">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Pricing &amp; plans</div>
            <div class="faq-section-sub">Trials, upgrades, unit limits, the guarantee.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Do I need a credit card to start a trial?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
              ...
              <div class="helpful"><span class="helpful-label">Was this helpful?</span><button class="helpful-btn" data-vote="yes"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H7V10l4.3-6.88a1.3 1.3 0 0 1 2.38 0Z"/></svg>Yes</button><button class="helpful-btn" data-vote="no"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 14V2"/><path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H17v12l-4.3 6.88a1.3 1.3 0 0 1-2.38 0Z"/></svg>No</button></div>
            </div>
          </div>

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What's the Founders cohort and how do I get it?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I upgrade or downgrade mid-subscription?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What happens if I exceed my plan's unit limit?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Do you offer annual billing discounts?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Is there a setup fee or migration fee?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How does the $100 guarantee actually work?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 2. Getting started -->
      <section class="faq-section" id="getting-started" data-section="getting-started">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Getting started</div>
            <div class="faq-section-sub">First day, migrations, state laws, whether you need an IT person.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How long does setup take?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Do I need to be tech-savvy?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I import data from AppFolio, Buildium, or DoorLoop?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What if I'm coming from spreadsheets?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Do you work with my state's lease laws?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I run this as a side-hustle landlord?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 3. Rent & payments -->
      <section class="faq-section" id="payments" data-section="payments">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Rent &amp; payments</div>
            <div class="faq-section-sub">How money moves, fees, late charges, bounced ACH.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How do my tenants pay?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What are the ACH and card fees?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Who holds my money — you or me?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">When do I get paid out?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What about split rent between roommates?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What happens when a payment bounces?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I add late fees automatically?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 4. Tenants & applications -->
      <section class="faq-section" id="tenants-apps" data-section="tenants-apps">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Tenants &amp; applications</div>
            <div class="faq-section-sub">Screening, fees, cosigners, FCRA compliance.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How do tenants apply?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Who pays the $45 application fee?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What credit and background check do you run?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I require cosigners?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What if my applicant is self-employed?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Is there an FCRA-compliant rejection letter?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 5. Leases & documents -->
      <section class="faq-section" id="leases" data-section="leases">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="13" y2="17"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Leases &amp; documents</div>
            <div class="faq-section-sub">Templates, e-sign, amendments, renewals.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Do you have state-specific lease templates?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Is your e-sign legally binding?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I use my own custom lease?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Where are signed leases stored?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How do I amend a lease mid-term?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What happens at renewal time?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 6. Accounting & taxes -->
      <section class="faq-section" id="accounting" data-section="accounting">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><line x1="3" y1="20" x2="21" y2="20"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Accounting &amp; taxes</div>
            <div class="faq-section-sub">QuickBooks, Schedule E, 1099s, CPA access.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Will my accountant understand this?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Do you sync with QuickBooks?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How does Schedule E work?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Will I get a 1099 for my vendors?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What about multi-LLC tax tracking?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can I give my CPA access?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 7. For tenants -->
      <section class="faq-section" id="tenants-asking" data-section="tenants-asking">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          </div>
          <div>
            <div class="faq-section-title">For tenants</div>
            <div class="faq-section-sub">If you rent from a Tenantory landlord and showed up here confused.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Why is my rent going through Tenantory?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Is my information safe?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">How do I set up autopay?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Who do I contact if something breaks?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What happens when my lease ends?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
      ...
      <!-- 8. Security & trust -->
      <section class="faq-section" id="security" data-section="security">
        <div class="faq-section-head">
          <div class="faq-section-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          </div>
          <div>
            <div class="faq-section-title">Security &amp; trust</div>
            <div class="faq-section-sub">Encryption, compliance, bus-factor, data agreements.</div>
          </div>
        </div>
        <div class="faq-list">

          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Is my data encrypted?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Are you SOC 2 certified?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Can your engineers see my tenant data?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">What if you go out of business?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
          ...
          <div class="faq-item">
            <button class="faq-q"><span class="q-text">Where can I get a DPA?</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
            <div class="faq-a">
  ...
  <section class="unanswered">
    <div class="unans-card">
      <div class="unans-label">Still stuck?</div>
      ...
      <div class="unans-actions">
        <a class="btn btn-pink btn-lg" href="mailto:hello@tenantory.com">
        ...
        <a class="btn btn-ghost btn-lg" href="demo.html">
        ...
        <a class="btn btn-ghost btn-lg" href="mailto:faq@tenantory.com?subject=FAQ%20suggestion">
