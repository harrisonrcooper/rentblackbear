...
// Mock ported verbatim from ~/Desktop/tenantory/for-coliving.html.
...
const MOCK_HTML = `<!-- Topbar -->
  <header class="topbar">
    ...
    <nav class="tb-nav">
      ...
      <a class="tb-nav-item active" href="for-coliving.html">For co-living</a>
  ...
  <section class="hero">
    ...
    <div class="hero-actions">
      ...
      <a class="btn btn-ghost btn-lg" href="#rentroll">See the per-room rent roll</a>
    </div>
    <div class="hero-meta">
  ...
  <!-- Why other tools break -->
  <section class="section">
    <div class="sec-eyebrow">The problem</div>
    <h2 class="sec-h2">Why every PM tool you've tried breaks for co-living.</h2>
    <p class="sec-lead">We've run the AppFolio trial. We've run the Buildium trial. We've paid for Landlord Studio, RentRedi, TurboTenant. <strong>They all break in the same places.</strong> Here's the list, in order of how much it actually costs you.</p>

    <div class="break-grid">
      <div class="break-card">
        <div class="break-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg>
        </div>
      ...
      <div class="break-card">
        <div class="break-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 10h12"/><path d="M9 14h12"/><path d="M9 18h12"/><path d="M3 10h3"/><path d="M3 14h3"/><path d="M3 18h3"/></svg>
        </div>
      ...
      <div class="break-card">
        <div class="break-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>
        </div>
      ...
      <div class="break-card">
        <div class="break-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 13h6"/><path d="M9 17h6"/></svg>
        </div>
  ...
  <!-- What Tenantory does differently -->
  <section class="section">
    <div class="sec-eyebrow">The fix</div>
    <h2 class="sec-h2">What Tenantory does differently.</h2>
    <p class="sec-lead">Every feature below is live today and I use all of them on Black Bear Rentals. <strong>Not on a roadmap. Not a beta.</strong> Open the trial, add a co-living property, and every one of these lights up.</p>

    <div class="sol-grid">
      <div class="sol-card">
        <div class="sol-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M5 21V11l7-4v14"/><path d="M19 21V13l-7-4"/><circle cx="8" cy="16" r="1"/><circle cx="15" cy="16" r="1"/></svg>
        </div>
      ...
      <div class="sol-card">
        <div class="sol-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 10h18"/><path d="M9 10v10"/></svg>
        </div>
      ...
      <div class="sol-card">
        <div class="sol-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M7 10V7a5 5 0 0 1 10 0v3"/><rect x="5" y="10" width="14" height="11" rx="2"/></svg>
        </div>
      ...
      <div class="sol-card">
        <div class="sol-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/></svg>
        </div>
      ...
      <div class="sol-card">
        <div class="sol-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v7H2V8l6-6h8v4"/><path d="M16 11V7h5l3 4v5h-3"/><circle cx="7" cy="18" r="2"/><circle cx="19" cy="18" r="2"/></svg>
        </div>
  ...
  <!-- Per-room rent roll screenshot callout -->
  <section class="section" id="rentroll">
    <div class="sec-eyebrow">What it looks like</div>
    <h2 class="sec-h2">The rent roll your banker actually wants.</h2>
    <p class="sec-lead">This is a real rent roll from a real co-living portfolio — names changed, numbers real. <strong>Property → room → tenant → status.</strong> One click to PDF. One link to your LPs.</p>
    ...
    <div class="shot-wrap">
      ...
      <div class="shot-browser">
        ...
        <div class="shot-body">
          <div class="shot-head-row">
            <div class="shot-title">Rent roll — April 2026</div>
            <div class="shot-filters">
              <span class="shot-chip">Grouped by property</span>
              <span class="shot-chip muted">3 properties</span>
              <span class="shot-chip muted">15 rooms</span>
            </div>
          </div>

          <div class="rentroll">
            <div class="rr-row rr-header">
              <div class="rr-cell">Property / Room</div>
              <div class="rr-cell">Tenant</div>
              <div class="rr-cell">Rent</div>
              <div class="rr-cell">Status</div>
              <div class="rr-cell">Lease ends</div>
            </div>

            <!-- Oak House -->
            <div class="rr-row rr-property">
              <div class="rr-cell rr-name">
                <span class="rr-prop-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12 12 3l9 9"/><path d="M5 10v10h14V10"/></svg></span>
                Oak House · 412 Clinton Ave
              </div>
              <div class="rr-cell rr-tenant">6 rooms</div>
              <div class="rr-cell rr-rent">$5,100</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok">6/6 occupied</span></div>
              <div class="rr-cell"></div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 1</div>
              <div class="rr-cell rr-tenant">Marcus K.</div>
              <div class="rr-cell rr-rent">$900</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Sep 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 2</div>
              <div class="rr-cell rr-tenant">Priya S.</div>
              <div class="rr-cell rr-rent">$875</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Jan 2027</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 3</div>
              <div class="rr-cell rr-tenant">David L.</div>
              <div class="rr-cell rr-rent">$850</div>
              <div class="rr-cell rr-status"><span class="rr-badge part">Partial</span></div>
              <div class="rr-cell rr-tenant">Jun 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 4 (master)</div>
              <div class="rr-cell rr-tenant">Elena R.</div>
              <div class="rr-cell rr-rent">$1,050</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Dec 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 5</div>
              <div class="rr-cell rr-tenant">James W.</div>
              <div class="rr-cell rr-rent">$825</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Aug 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 6</div>
              <div class="rr-cell rr-tenant">Nia B.</div>
              <div class="rr-cell rr-rent">$600</div>
              <div class="rr-cell rr-status"><span class="rr-badge due">Past due 3d</span></div>
              <div class="rr-cell rr-tenant">Nov 2026</div>
            </div>
            ...
            <div class="rr-row rr-property">
              ...
              <div class="rr-cell rr-tenant">5 rooms</div>
              <div class="rr-cell rr-rent">$4,325</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok">5/5 occupied</span></div>
              <div class="rr-cell"></div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 1</div>
              <div class="rr-cell rr-tenant">Zoe H.</div>
              <div class="rr-cell rr-rent">$875</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Autopay</span></div>
              <div class="rr-cell rr-tenant">Apr 2027</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 2</div>
              <div class="rr-cell rr-tenant">Tomás V.</div>
              <div class="rr-cell rr-rent">$825</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Autopay</span></div>
              <div class="rr-cell rr-tenant">Oct 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 3</div>
              <div class="rr-cell rr-tenant">Grace P.</div>
              <div class="rr-cell rr-rent">$825</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Jul 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 4</div>
              <div class="rr-cell rr-tenant">Devon M.</div>
              <div class="rr-cell rr-rent">$875</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">May 2027</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 5 (basement)</div>
              <div class="rr-cell rr-tenant">Anika J.</div>
              <div class="rr-cell rr-rent">$925</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Autopay</span></div>
              <div class="rr-cell rr-tenant">Feb 2027</div>
            </div>
            ...
            <div class="rr-row rr-property">
              ...
              <div class="rr-cell rr-tenant">4 rooms</div>
              <div class="rr-cell rr-rent">$3,400</div>
              <div class="rr-cell rr-status"><span class="rr-badge part">3/4 occupied</span></div>
              <div class="rr-cell"></div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 1</div>
              <div class="rr-cell rr-tenant">Ravi T.</div>
              <div class="rr-cell rr-rent">$900</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Autopay</span></div>
              <div class="rr-cell rr-tenant">Mar 2027</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 2</div>
              <div class="rr-cell rr-tenant">Sam O.</div>
              <div class="rr-cell rr-rent">$850</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Dec 2026</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 3</div>
              <div class="rr-cell rr-tenant">Lena F.</div>
              <div class="rr-cell rr-rent">$825</div>
              <div class="rr-cell rr-status"><span class="rr-badge ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>Paid</span></div>
              <div class="rr-cell rr-tenant">Jan 2027</div>
            </div>
            <div class="rr-row rr-room">
              <div class="rr-cell rr-name">Bedroom 4</div>
              <div class="rr-cell rr-tenant">—</div>
              <div class="rr-cell rr-rent">$825</div>
              <div class="rr-cell rr-status"><span class="rr-badge vac">Vacant · listing live</span></div>
              <div class="rr-cell rr-tenant">—</div>
            </div>
          ...
          <div class="shot-head-row" style="margin-top: 18px;">
            <div class="shot-filters">
              <span class="shot-chip">Export PDF</span>
              <span class="shot-chip muted">Share with LP</span>
              <span class="shot-chip muted">Schedule monthly</span>
            </div>
          </div>
        </div>
      </div>

      <p class="shot-caption">This exact report runs across <strong>Black Bear Rentals</strong> on the first of every month. My LPs get a PDF in their inbox at 8am. The whole job takes me zero minutes — because I never touch it.</p>
    </div>
  </section>
  ...
  <section class="section">
    ...
    <h2 class="sec-h2">18 rooms. Three houses. Atlanta.</h2>
    <p class="sec-lead">Marcus runs a co-living operation across three Atlanta properties — 18 bedrooms total. For three years he held it together with spreadsheets, QuickBooks, and a hand-coded landing page. Here's what changed in his first 90 days on Tenantory.</p>

    <div class="case-wrap">
      <div class="case-side">
        <div class="case-avatar-row">
          <div class="case-avatar">MA</div>
          <div>
            <div class="case-name">Marcus A.</div>
            <div class="case-role">Founder · co-living operator · Atlanta, GA</div>
          </div>
        </div>

        <div class="case-stat">
          <div class="case-stat-label">Portfolio</div>
          <div class="case-stat-value">18 rooms · 3 houses</div>
        </div>

        <div class="case-stat">
          <div class="case-stat-label">Switched from</div>
          <div class="case-stat-value">Spreadsheets + QuickBooks</div>
        </div>

        <div class="case-stat">
          <div class="case-stat-label">Maintenance cost change · Q1</div>
          <div class="case-stat-value"><em>-22%</em></div>
        </div>

        <div class="case-stat">
          <div class="case-stat-label">On Tenantory since</div>
          <div class="case-stat-value">Nov 2025</div>
        </div>
      </div>

      <div class="case-body">
        <p class="case-quote">The per-room rent roll is the killer feature. Other PM tools think a "unit" is an apartment. For co-living, that's useless — I needed a room as the unit. Tenantory got that on day one. Plus the investor PDF that auto-generates every month? My LPs love it. Makes me look like I have ops.</p>

        <p class="case-detail">Before Tenantory, Marcus ran rent reconciliation out of a Google Sheet with one tab per property and one row per bedroom. Three payment methods flowed in — Zelle, Venmo, the occasional check — and it took him a full Saturday every month to match rent paid against rent owed. Investor reports were hand-built in PowerPoint.</p>

        <p class="case-detail"><strong>The unlock was per-room accounting.</strong> "I had one LP ask me for year-over-year per-room rent growth on Oak House, and I couldn't answer it without an afternoon of Excel. On Tenantory it's two clicks."</p>

        <p class="case-detail">The unexpected win was <strong>vendor adoption</strong>. "Maintenance costs dropped 22% in Q1 because vendors adopted the vendor portal — fewer emergency calls, more scheduled visits. Joel, my plumber, says it's the only PM tool he doesn't hate. I think that's a real bar."</p>

        <p class="case-detail">Housemate-aware portal solved a problem he didn't know he had: "Before, if one tenant was late on rent, the other five in the house could see it in our shared group chat when I'd send the reminder. Awkward. Tenantory sends each tenant their own reminder. Housemates never know."</p>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    ...
    <h2 class="sec-h2">Most co-living operators live on Pro.</h2>
    <p class="sec-lead">Up to 50 rooms for $99 a month. Flat. A 10-bedroom operator pays $9.90 per room. A 40-bedroom operator pays $2.47 per room. <strong>The math is boring and that's the point.</strong></p>

    <div class="pricenote">
      <div>
        <div class="pricenote-label">Pro</div>
        <div class="pricenote-title">$99/mo. Up to 50 rooms. Everything on this page.</div>
        <div class="pricenote-sub">Per-room leases, per-room rent roll, shared utility splitting, housemate-aware portal, room-level tickets, your own branded subdomain, AI application scoring, 1099 automation, Schedule E export, and a <strong>14-day free trial with no credit card</strong>. If it doesn't save you 12 hours in the first 30 paid days, full refund plus $100 wired for your time.</div>
      </div>
  ...
  <!-- FAQ -->
  <section class="faq">
    <h2 class="faq-h2">Co-living questions we get every week.</h2>
  ...
  <section class="cta-bottom">
    <div class="cta-card">
      ...
      <div class="cta-actions">
        ...
        <a class="btn btn-ghost btn-lg" href="mailto:harrison@tenantory.com?subject=Co-living%20operator%20question">Email Harrison directly</a>
      </div>
      <div class="cta-note">Built in Huntsville, AL by an operator with 15+ rooms of his own.</div>
    </div>
  </section>
