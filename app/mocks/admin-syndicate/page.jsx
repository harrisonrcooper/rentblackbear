...
// Mock ported from ~/Desktop/blackbear/admin-syndicate.html.
              ...
              <div className="card-body">
                <div className="radio-list" id="apply-radio">
                  <label className="radio-card on">
                    <input type="radio" name="apply" value="blackbear" checked />
                    <span className="dot" />
                    <div className="radio-card-body">
                      <div className="radio-card-title">Black Bear Rentals apply page <span style={{fontSize: "10px", fontWeight: "800", letterSpacing: "0.06em", textTransform: "uppercase", background: "var(--green-bg)", color: "var(--green-dark)", padding: "2px 7px", borderRadius: "100px", marginLeft: "6px"}}>Recommended</span></div>
                  ...
                  <label className="radio-card">
                    ...
                    <div className="radio-card-body">
                      ...
                      <div className="radio-card-sub">Send applicants to your own form. Leads won't show in Black Bear Rentals.</div>
                  ...
                  <label className="radio-card">
                    ...
                    <div className="radio-card-body">
                      ...
                      <div className="radio-card-sub">Show both options on the listing. Some tenants prefer Black Bear Rentals, some prefer your form.</div>
                    </div>
                  </label>
                </div>
              </div>
            ...
            <div className="card" style={{marginTop: "24px"}}>
              ...
              <div className="card-body">
                <div className="channel-list" id="channel-list">
                  ...
                  <label className="channel-card on" data-channel="blackbear" data-reach="320">
                    <div className="channel-logo blackbear"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12 12 3l9 9" /><path d="M5 10v10h14V10" /><path d="M10 20v-6h4v6" /></svg></div>
                    <div className="channel-info">
                      <div className="channel-name-row">
                        <span className="channel-name">Black Bear Rentals vacancy page</span>
...
Apply: rentblackbear.com/apply/lee908-a</div>
          ...
          <div className="sticky-col">
            ...
            <div className="analytics-card">
              ...
              <div className="analytics-row" data-channel="blackbear">
                <span className="analytics-row-label">Black Bear Rentals</span>
        ...
        <div className="push-modal">
          ...
          <div className="push-modal-actions">
            ...
            <button className="btn btn-primary" id="push-view-btn" style={{display: "none"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><path d="M15 3h6v6M10 14 21 3" /></svg>
              View listing on Black Bear Rentals
            </button>
          </div>
        </div>
      </div>
