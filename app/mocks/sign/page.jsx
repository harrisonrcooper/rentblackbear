...
// Mock ported verbatim from ~/Desktop/tenantory/sign.html.
...
const MOCK_HTML = `<header class="topbar">
    <div class="tb-brand">
      ...
      <div>
        ...
        <div class="tb-brand-sub">Lease signing</div>
      </div>
    </div>
    <div class="tb-help">
  ...
  <div class="status-banner">
    ...
    <div>
      <div class="status-title">You're approved, Jane.</div>
      <div class="status-sub">Harrison reviewed your application and approved it on <strong>Apr 16, 2026</strong>. Sign your lease and pay the move-in total below to lock in <strong>Room A · 908 Lee Drive · May 1</strong>.</div>
    </div>
  </div>
  ...
  <main class="wrap">
    ...
    <!-- ===== Left: lease summary ===== -->
    <aside class="summary">
      <div class="summary-eyebrow">Lease summary</div>
      <div class="summary-title">Room A · 908 Lee Drive</div>
      <div class="summary-addr">Co-living house · Huntsville, AL 35816</div>

      <div class="term-row"><span class="term-key">Tenant</span><span class="term-val">Jane Doe</span></div>
      <div class="term-row"><span class="term-key">Term</span><span class="term-val">12 months</span></div>
      <div class="term-row"><span class="term-key">Start date</span><span class="term-val">May 1, 2026</span></div>
      <div class="term-row"><span class="term-key">End date</span><span class="term-val">Apr 30, 2027</span></div>
      <div class="term-row"><span class="term-key">Monthly rent</span><span class="term-val">$750.00</span></div>
      <div class="term-row"><span class="term-key">Due</span><span class="term-val">1st of month</span></div>
      <div class="term-row"><span class="term-key">Late fee</span><span class="term-val">$25 after the 5th</span></div>
      <div class="term-row"><span class="term-key">Security deposit</span><span class="term-val">$750.00</span></div>
      <div class="term-row"><span class="term-key">Pet deposit</span><span class="term-val">None</span></div>
      <div class="term-row"><span class="term-key">Utilities</span><span class="term-val">All included</span></div>

      <div class="totals">
        <div class="totals-row"><span>First month's rent</span><span>$750.00</span></div>
        <div class="totals-row"><span>Security deposit</span><span>$750.00</span></div>
        <div class="totals-row"><span>Admin fee</span><span style="color:var(--green-dark);font-weight:700;">$0.00</span></div>
        <div class="totals-row big"><span>Total due today</span><span>$1,500.00</span></div>
      </div>

      <div class="signers">
        <div class="signers-title">Signers</div>
        <div class="signer-row">
          <div class="signer-avatar">HC</div>
          <div class="signer-info">
            <div class="signer-name">Harrison Cooper</div>
            <div class="signer-role">Owner · Black Bear Rentals</div>
          </div>
          <span class="signer-state signed">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            Signed
          </span>
        </div>
        <div class="signer-row">
          <div class="signer-avatar" style="background: linear-gradient(135deg, var(--accent), var(--brand-bright));">JD</div>
          <div class="signer-info">
            <div class="signer-name">Jane Doe</div>
            <div class="signer-role">Tenant · awaiting your signature</div>
          </div>
          <span class="signer-state you" id="signerState">Your turn</span>
        </div>
      </div>
    </aside>

    <!-- ===== Right: Document → Sign → Pay → Submit ===== -->
    <section class="main-col">

      <!-- Step 1: Document -->
      <div class="panel">
        <div class="panel-head">
          <div class="panel-num done">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
          </div>
          <div class="panel-title">Review your lease</div>
          <span class="panel-state review" id="reviewState">8 sections · ~5 min read</span>
        </div>
        <div class="panel-body" style="padding-top:8px;padding-bottom:8px;">

          <div class="doc-section open">
            <div class="doc-section-head" onclick="toggleSection(this.parentElement)">
              <div class="doc-section-num">1</div>
              <div class="doc-section-title">Term &amp; rent</div>
              <div class="doc-section-meta">2 paragraphs</div>
              <svg class="doc-section-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
            <div class="doc-section-body">
              <p>This lease begins on <span class="doc-highlight">May 1, 2026</span> and ends on <span class="doc-highlight">April 30, 2027</span>. Monthly rent is <span class="doc-highlight">$750.00</span>, due on the 1st of each month. Rent paid by the 5th avoids late fees. Late rent incurs a flat $25 fee plus $5/day after the 10th, capped at 5% of monthly rent per Alabama Code §35-9A-161.</p>
          ...
          <div class="doc-section">
            <div class="doc-section-head" onclick="toggleSection(this.parentElement)">
              ...
              <div class="doc-section-title">Security deposit</div>
              <div class="doc-section-meta">1 paragraph</div>
              <svg class="doc-section-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
            <div class="doc-section-body">
              <p>Tenant pays a <span class="doc-highlight">$750.00</span> refundable security deposit at lease signing. Landlord holds the deposit in a separate Alabama account per §35-9A-201. Within <span class="doc-highlight">35 days of move-out</span>, Landlord returns the deposit minus any documented deductions for damages beyond ordinary wear and tear, with an itemized statement.</p>
            </div>
          </div>
          ...
          <div class="doc-section">
            <div class="doc-section-head" onclick="toggleSection(this.parentElement)">
              ...
              <div class="doc-section-title">Utilities &amp; services</div>
              <div class="doc-section-meta">1 paragraph</div>
              <svg class="doc-section-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
            <div class="doc-section-body">
          ...
          <div class="doc-section">
            <div class="doc-section-head" onclick="toggleSection(this.parentElement)">
              ...
              <div class="doc-section-title">Maintenance &amp; repairs</div>
              <div class="doc-section-meta">2 paragraphs</div>
              <svg class="doc-section-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
            <div class="doc-section-body">
              <p>Tenant submits maintenance requests through the Black Bear tenant portal. Landlord responds within <span class="doc-highlight">24 hours</span> for non-emergency requests and same-day for emergencies (no heat in winter, no water, gas leak, flood, fire, no electricity). Tenant grants Landlord permission to enter the unit for repairs with 24 hours notice, except in true emergencies.</p>
          ...
          <div class="doc-section">
            <div class="doc-section-head" onclick="toggleSection(this.parentElement)">
              <div class="doc-section-num">8</div>
              <div class="doc-section-title">Signatures &amp; acknowledgments</div>
              <div class="doc-section-meta">Final</div>
              <svg class="doc-section-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </div>
            <div class="doc-section-body">
        ...
        <div class="doc-foot">
          ...
          <a href="#" onclick="event.preventDefault(); toast('PDF downloaded')">
      ...
      <div class="panel">
        <div class="panel-head">
          <div class="panel-num" id="signPanelNum">2</div>
          <div class="panel-title">Sign your name</div>
          <span class="panel-state todo" id="signPanelState">Required</span>
        </div>
        <div class="panel-body">

          <div class="sig-row">
            <div class="field">
              <label class="field-label">Legal first name</label>
              <input class="input" type="text" id="firstName" value="Jane" oninput="updateSig()">
            </div>
            <div class="field">
              <label class="field-label">Legal last name</label>
              <input class="input" type="text" id="lastName" value="Doe" oninput="updateSig()">
            </div>
          </div>

          <label class="field-label">Type your full name to sign</label>
          <input class="sig-typed-input" type="text" id="typedSig" placeholder="Type your full legal name exactly as above" oninput="updateSig()">

          <div class="sig-pad-wrap" id="sigWrap" style="margin-top:14px;">
            <div class="sig-render sig-render-empty" id="sigRender">Your signature will appear here</div>
            <div class="sig-render-line">
      ...
      <div class="panel">
        <div class="panel-head">
          <div class="panel-num" id="payPanelNum">3</div>
          <div class="panel-title">Pay your move-in total</div>
          <span class="panel-state todo" id="payPanelState">$1,500.00</span>
        </div>
        <div class="panel-body">

          <div class="breakdown">
            <div class="breakdown-row"><span>First month's rent (May 2026)</span><span>$750.00</span></div>
            <div class="breakdown-row"><span>Security deposit (refundable)</span><span>$750.00</span></div>
            <div class="breakdown-row"><span>Application fee</span><span><span class="strike">$45.00</span><span class="free">Already paid</span></span></div>
            <div class="breakdown-row"><span>Admin fee</span><span class="free">$0.00</span></div>
            <div class="breakdown-row total"><span>Total today</span><span>$1,500.00</span></div>
          </div>

          <label class="field-label" style="margin-bottom:10px;display:block;">Payment method</label>
          <div class="method-pick selected" data-method="bank">
            <div class="method-pick-radio"></div>
            <div class="method-icon bank">ACH</div>
            <div style="flex:1;">
              <div class="method-label">Bank transfer (recommended)</div>
              <div class="method-sub">No fees · funds clear in 1–3 business days</div>
            </div>
          </div>
          <div class="method-pick" data-method="card">
            <div class="method-pick-radio"></div>
            <div class="method-icon card">CARD</div>
            <div style="flex:1;">
              <div class="method-label">Credit or debit card</div>
              <div class="method-sub">+$44.25 processing fee · funds clear instantly</div>
            </div>
          </div>

          <div style="display:flex;align-items:center;gap:12px;margin-top:14px;padding:12px 14px;background:var(--brand-pale);border-radius:8px;border:1px solid var(--brand-soft);">
            <svg viewBox="0 0 24 24" fill="none" stroke="var(--brand-dark)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;flex-shrink:0;"><path d="M12 2 3 6v6c0 5.5 4 10 9 11 5-1 9-5.5 9-11V6l-9-4z"/><path d="m9 12 2 2 4-4"/></svg>
            <div style="font-size:12.5px;color:var(--brand-dark);">
              <strong style="font-weight:700;">Stripe-secured.</strong> Your payment goes directly to Black Bear's escrow account. Tenantory never holds your funds.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="panel">
        <div class="panel-head">
          <div class="panel-num" id="agreePanelNum">4</div>
          <div class="panel-title">Confirm &amp; submit</div>
          <span class="panel-state todo" id="agreePanelState">Last step</span>
        </div>
        <div class="panel-body">

          <div class="agree-block">
            <div class="agree-row" data-agree="read" onclick="this.classList.toggle('checked'); updateSubmit()">
            ...
            <div class="agree-row" data-agree="bind" onclick="this.classList.toggle('checked'); updateSubmit()">
              <div class="agree-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
            ...
            <div class="agree-row" data-agree="pay" onclick="this.classList.toggle('checked'); updateSubmit()">
              <div class="agree-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
          ...
          <div class="submit-bar">
            ...
            <button class="btn btn-primary" id="submitBtn" disabled onclick="submitLease()">
  ...
  <div class="success-overlay" id="successOverlay">
    <div class="success-card">
      ...
      <p class="success-sub">Your lease is fully executed and your $1,500 move-in total is processing. <strong>You move in May 1.</strong> Harrison will reach out by Apr 28 to coordinate keys and the move-in walkthrough.</p>
      ...
      <div class="timeline">
        <div class="timeline-row">
          ...
          <div class="timeline-text"><strong>Today</strong> — receipt + executed lease emailed to you</div>
        </div>
        <div class="timeline-row">
          <div class="timeline-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
          <div class="timeline-text"><strong>Today</strong> — your tenant portal account is live</div>
        </div>
        <div class="timeline-row">
          <div class="timeline-icon upcoming">3</div>
          <div class="timeline-text muted"><strong>Apr 28</strong> — Harrison calls to confirm move-in time &amp; key handoff</div>
        </div>
        <div class="timeline-row">
          <div class="timeline-icon upcoming">4</div>
          <div class="timeline-text muted"><strong>May 1</strong> — move-in day &amp; walkthrough inspection</div>
        </div>
        <div class="timeline-row">
          <div class="timeline-icon upcoming">5</div>
          <div class="timeline-text muted"><strong>Jun 1</strong> — first regular rent payment due (autopay reminder will go out May 25)</div>
        </div>
      </div>
