...
// Mock ported verbatim from ~/Desktop/tenantory/about.html.
...
const MOCK_HTML = `<!-- Topbar -->
  <header class="topbar">
    ...
    <nav class="tb-nav">
      ...
      <a class="tb-nav-item active" href="about.html">About</a>
    ...
    <div class="hero-grid">
      <div class="hero-copy">
        <div class="hero-eyebrow">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 9.1 8.3 2 9.3l5.1 5-1.2 7 6.1-3.3 6.1 3.3-1.2-7 5.1-5-7.1-1z"/></svg>
          Founder note · Huntsville, AL
        </div>
        <h1>I wasn't supposed to <em>build software.</em></h1>
        <p class="hero-sub">I'm an operator first. I own rental houses, I clean gutters, I unclog toilets at 11pm, and somewhere along the way I also wrote the property management platform I wished existed. This is the story of how that happened and why it matters if you run rentals.</p>
        <div class="hero-meta">
      ...
      <div class="hero-visual">
        <div class="hero-visual-stack">
          <div class="avatar-big">HC</div>
          <div class="photo-plate">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="11" r="2"/><path d="m21 15-5-5L8 18"/></svg>
            <div class="photo-plate-cap">Photo dropping soon.<br>Probably of me on the roof of 908 Lee Dr with a ladder I shouldn't be on.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="story">
    ...
    <div class="story-beat">
      <div class="year">2019 · Beat 1</div>
    ...
    <div class="story-beat">
      <div class="year">2020 – 2023 · Beat 2</div>
    ...
    <div class="story-beat">
      <div class="year">Early 2024 · Beat 3</div>
    ...
    <div class="story-beat">
      <div class="year">January 2026 · Beat 4</div>
    ...
    <div class="story-beat">
      <div class="year">April 2026 · Beat 5</div>
  ...
  <section class="section">
    ...
    <h2 class="h2">Three things I've learned running 15 rooms.</h2>
    <p class="lede">Every product decision in Tenantory traces back to one of these. If something in the app feels obvious, it's because I lost money on it first.</p>
  ...
  <div class="quote-wrap">
    <div class="quote-card">
      ...
      <div class="quote-attr">
        <div class="quote-avatar">HC</div>
        <div class="quote-attr-text">
          <div class="quote-attr-name">Harrison Cooper</div>
          <div class="quote-attr-role">Founder, Tenantory · Operator, Black Bear Rentals</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="section">
    <span class="kicker">Counter-positioning</span>
    <h2 class="h2">What Tenantory is not.</h2>
    <p class="lede">We're small on purpose. Here's what you're explicitly not buying.</p>
    <div class="not-grid">
      <div class="not-card">
        <div class="not-x"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></div>
        <div>
  ...
  <section class="section">
    ...
    <h2 class="h2">Five principles I won't compromise.</h2>
    <p class="lede">Pin these on the wall. If we ever violate one of them, email me personally and I'll fix it.</p>
    <div class="values-grid">
      <div class="value">
        <div class="value-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg></div>
        <h4>Operator-first</h4>
        <p>Every feature is measured against: does this save a real operator real time or real money?</p>
      </div>
      <div class="value">
        <div class="value-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div>
        <h4>Transparent</h4>
        <p>Pricing on the website. Changelog public. Roadmap public. We publish MRR quarterly on Twitter.</p>
      </div>
      <div class="value">
        <div class="value-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>
        <h4>No lock-in</h4>
        <p>Export your full tenant, lease, and ledger data as CSV any time. Cancel in-app. No exit interview.</p>
      </div>
      <div class="value">
        <div class="value-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg></div>
      ...
      <div class="value">
        <div class="value-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/></svg></div>
  ...
  <section class="timeline-wrap">
    <div style="text-align: center; max-width: 720px; margin: 0 auto 12px;">
      <span class="kicker">The path here</span>
      <h2 class="h2">Seven years, one detour through AppFolio.</h2>
    </div>
    <div class="timeline">
      <div class="timeline-items">
        <div class="tl-item">
          ...
          <div class="tl-title">First rental</div>
          <div class="tl-desc">Accidental-landlord starter home in southwest Huntsville. $1,150 a month.</div>
        </div>
        <div class="tl-item">
          <div class="tl-dot"></div>
          <div class="tl-year">2020 – 2023</div>
          <div class="tl-title">The spreadsheet era</div>
          <div class="tl-desc">Grew from 3 rooms to 15 across four co-living houses. All run on one Google Sheet.</div>
        </div>
        <div class="tl-item">
          <div class="tl-dot"></div>
          <div class="tl-year">2024</div>
          <div class="tl-title">AppFolio trial</div>
          <div class="tl-desc">Paid $280/mo for five months. Tenants saw AppFolio's brand, not mine. Cancelled in May.</div>
        </div>
        <div class="tl-item pink">
          <div class="tl-dot"></div>
          <div class="tl-year">Jan 2026</div>
          <div class="tl-title">First commit</div>
          <div class="tl-desc">Tenant emailed about a tax statement. Sheet was wrong. I opened a repo the next morning.</div>
        </div>
        <div class="tl-item now">
          <div class="tl-dot"></div>
          <div class="tl-year">Today</div>
          <div class="tl-title">Public launch</div>
          <div class="tl-desc">Black Bear runs fully on Tenantory. Two paying operators in Birmingham. You could be #3.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="dogfood">
    <div class="dogfood-card">
      <div class="dogfood-badge">WE EAT<br>OUR OWN<br>COOKING</div>
  ...
  <section class="section section-narrow">
    ...
    <h2 class="h2">Currently, a team of one.</h2>
    <p class="lede">I'd rather move slow and hire the right second person than raise a round and hire four wrong ones.</p>
    <div class="team-grid">
      <div class="team-card">
        <div class="team-avatar">HC</div>
        <div class="team-info">
          <h4>Harrison Cooper</h4>
          <div class="role">Founder · Engineer · Plunger-in-chief</div>
      ...
      <div class="team-empty">
        <strong>Hire #2 is open.</strong> Probably a senior full-stack engineer who has also rented a bedroom out in their life. If that's you, <a href="mailto:harrison@tenantory.com" style="color: var(--blue); font-weight: 600;">say hello.</a>
      </div>
    </div>
  </section>
  ...
  <section class="section section-narrow">
    ...
    <h2 class="h2">I read every email. Seriously.</h2>
    <p class="lede">There is no support tier. There is me. If you hit a wall, I'd rather know about it than not.</p>
    <div class="contact-grid">
      <a class="contact-card" href="mailto:harrison@tenantory.com">
        <div class="contact-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
        </div>
        <h4>Email</h4>
        <div class="val">harrison@tenantory.com</div>
        <div class="desc">Best channel. Response usually within 4 business hours.</div>
      </a>
      <a class="contact-card" href="https://twitter.com/tenantory" target="_blank" rel="noopener">
        <div class="contact-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2H22L14.5 10.5 23 22H16L11 15L5 22H1L9 13L0.5 2H7.5L12 8L18 2Z"/></svg>
        </div>
        <h4>Twitter / X</h4>
        <div class="val">@tenantory</div>
        <div class="desc">Where I post build-log updates and roast bad PM software.</div>
      </a>
      <a class="contact-card" href="#calendly">
        <div class="contact-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        </div>
        <h4>Book 15 minutes with me</h4>
        <div class="val">cal.com/harrison-cooper</div>
        <div class="desc">Free, no demo pitch. Bring questions or just say hi.</div>
      </a>
    </div>
  </section>
  ...
  <section class="cta-bottom">
    <div class="cta-card">
      ...
      <div class="cta-note">87 spots left · Built in Huntsville, AL</div>
    </div>
  </section>
