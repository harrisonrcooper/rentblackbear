...
// Mock ported verbatim from ~/Desktop/tenantory/privacy.html.
...
const MOCK_HTML = `<!-- Topbar -->
  ...
  <section class="hero">
    <div class="hero-inner">
      ...
      <p class="hero-sub">We built Tenantory to hold the most sensitive information a landlord owns: tenant PII, bank details, leases, and screening reports. This is exactly what we collect, why, and how it's protected.</p>
      <div class="hero-meta">
        ...
        <a class="hero-link" href="#summary">
    ...
    <div class="grid">
      ...
      <main class="body">
        ...
        <section class="sec" id="s4">
          <h2><span class="num">04</span> Data Sharing & Third Parties</h2>
          ...
          <dl class="vendor-table">
            <div class="vendor-row"><dt>Provider</dt><dd>Purpose</dd></div>
            <div class="vendor-row"><dt>Stripe, Inc.</dt><dd>Subscription billing and tenant rent collection. Receives payment method data, transaction amounts, and customer identifiers.</dd></div>
            <div class="vendor-row"><dt>Plaid Inc.</dt><dd>Bank account verification and ACH authorization for tenants. Receives bank linkage tokens; Tenantory does not see bank credentials.</dd></div>
            <div class="vendor-row"><dt>TransUnion Rental Screening</dt><dd>Applicant credit, criminal, and eviction reports (where Operators enable screening). Receives applicant-authorized identifiers.</dd></div>
            <div class="vendor-row"><dt>Clerk, Inc.</dt><dd>User authentication, session management, and multi-factor authentication. Stores credentials and session tokens.</dd></div>
            <div class="vendor-row"><dt>Supabase, Inc.</dt><dd>Primary application database and file storage. Holds Customer Content encrypted at rest with row-level tenancy isolation.</dd></div>
            <div class="vendor-row"><dt>Resend, Inc.</dt><dd>Transactional email delivery (receipts, notices, invitations, password resets).</dd></div>
            <div class="vendor-row"><dt>Twilio, Inc.</dt><dd>SMS and voice delivery where enabled (for example, rent reminders and maintenance notifications to tenants).</dd></div>
            <div class="vendor-row"><dt>Vercel, Inc.</dt><dd>Application hosting, static asset delivery, and edge middleware. Processes HTTP request and response data.</dd></div>
            <div class="vendor-row"><dt>PostHog, Inc.</dt><dd>Product analytics and session-level debugging. Pseudonymous event data; no third-party ad tracking.</dd></div>
          </dl>
        ...
        <section class="sec" id="s5">
          <h2><span class="num">05</span> Cookies & Tracking</h2>
        ...
        <section class="sec" id="s6">
          <h2><span class="num">06</span> Data Security</h2>
        ...
        <section class="sec" id="s7">
          <h2><span class="num">07</span> Data Retention</h2>
        ...
        <section class="sec" id="s9">
          <h2><span class="num">09</span> California Residents (CCPA / CPRA)</h2>
        ...
        <section class="sec" id="s10">
          <h2><span class="num">10</span> EU / UK Residents (GDPR)</h2>
        ...
        <section class="sec" id="s13">
          <h2><span class="num">13</span> Contact Information</h2>
        ...
        <div class="contact">
          ...
          <div>
            <div class="contact-title">Questions about your data?</div>
            <div class="contact-sub">Ask our privacy team. We reply within two business days and handle formal requests within 30.</div>
          </div>
          <a class="btn btn-pink" href="mailto:legal@tenantory.com">Email legal@tenantory.com</a>
        </div>
