export default function Page() {
  ...
  return (
    <main style={{maxWidth:720,margin:"40px auto",padding:24,fontFamily:"var(--flg-font-sans)",color:"var(--flg-text)"}}>
      <h1 style={{fontSize:24,fontWeight:800,letterSpacing:"-0.02em"}}>Black Bear Rentals mocks</h1>
      <p style={{color:"var(--flg-text-muted)",marginTop:6}}>63 mocks ported from ~/Desktop/blackbear/. Real JSX conversion — each mock is a standalone Next.js page.</p>
