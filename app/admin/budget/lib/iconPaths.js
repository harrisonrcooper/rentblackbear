// Pure SVG path-data map. Lives separately from `icons.jsx` so
// non-React modules (colors.js, habits.js, etc.) can import the data
// without dragging the JSX-rendering Icon component into a place
// where vitest's parser doesn't understand JSX.
//
// `icons.jsx` re-exports ICON for back-compat — callers that already
// `import { ICON } from "./icons"` keep working.
...
export const ICON = {
  ...
  creditCard: ["M22 4H2a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1z", "M1 10h22"],
  piggy:    ["M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z", "M16 11h0"],
