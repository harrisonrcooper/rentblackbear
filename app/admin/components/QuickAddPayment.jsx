...
export default function QuickAddPayment({ charges, props, onRecord, onCancel, uid, TODAY, settings }) {
    ...
    <div className="card" style={{ marginBottom: 12 }}>
      <div className="card-bd">
        <h3 style={{ fontSize: 13, fontWeight: 800, marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={theme.success} strokeWidth="2" strokeLinecap="round"><path d="M12 5v14M5 12h14"/></svg>
          Record Payment
        </h3>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(140px,1fr))", gap: 10 }}>
          ...
          <div className="fld">
            <label>Charge {remaining > 0 && <span style={{ fontWeight: 400, color: theme.muted }}> -- ${remaining.toFixed(2)} remaining</span>}</label>
          ...
          <div className="fld">
            <label>Notes <span style={{ fontWeight: 400, color: theme.muted }}>(optional)</span></label>
