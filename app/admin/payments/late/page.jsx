...
// Mock ported from ~/Desktop/blackbear/admin-late-rent.html.
          ...
          <div className="auto-head">
            <div className="auto-title">
              ...
              <div>
                ...
                <p>Black Bear Rentals handles the chase. You only get pinged when something needs a human decision.</p>
              </div>
            </div>
  ...
  <div className="modal-backdrop" id="modal-log-payment">
    <div className="modal">
      <div className="modal-head">
        <h3>Log a payment</h3>
        <p>Use this when rent came in outside Black Bear Rentals (cash, check, bank transfer).</p>
      </div>
