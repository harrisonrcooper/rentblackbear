          ...
          {units.map(u=>{
            ...
            return(<div key={u.id}>
              ...
              {uIsWhole?(()=>{
                ...
                return(<div className="cal-rm cal-occ"><div className="cal-rm-l"><div className="cal-rm-n">{unitCount>1?u.name:prop.name} — ${u.rent||0}/mo</div><div className="cal-rm-d">{uRooms.length} bed · {u.baths||prop.baths} bath</div></div><span className="cal-rm-st" style={{background:CLR.occBg,color:CLR.occTx}}>Thru {fmtD(latestLe)}</span></div>);
              })():(
