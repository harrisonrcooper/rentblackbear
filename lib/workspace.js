...
//    the admin principal id maps 1:1 to a workspace slug, and all app_data
...
/**
 * Server-side: resolve workspace from the admin session.
 * MVP: workspace_id = the admin principal id itself.
