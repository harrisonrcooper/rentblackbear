...
export default function AddFirstProperty({
  ...
  ctaHref = "https://app.tenantory.com/admin/properties/new",
}) {
  return (
    <Layout preview="Step 1 of 3 — add your first property to Tenantory." brand="Tenantory">
      <Heading as="h1" style={sharedStyles.heading}>
        Add your first property to unlock everything else.
      </Heading>
      <Text style={sharedStyles.paragraph}>
        Hey {firstName}, Tenantory's automations, tenant portal, and lease generator all hinge on one thing: a property row. Takes ~60 seconds. Photos and bedrooms can come later.
      </Text>
